...
public:
    ...
    BMP::Pixel& operator()(int row, int column);
    const BMP::Pixel& operator()(int row, int column) const;
...
const BMP::Pixel BLACK = {(unsigned char)0, (unsigned char)0, (unsigned char)0};
